	...
	<body>
		<div class="site"><!-- SITE CONTAINER -->
			...
			<div class="container container_16">
				<div class='grid_16 center'><h1>Lifestyle By Date</h1></div>
				...
				<?php	
					...
					$sql_date = 'select distinct LSDATE from lsresult where PARTICIPANTID = '.$participantid;
					...
					{
						echo "<form action='lifestylereportindividual.php' method='post' name=form".$l.">";
						$lsdate = $row_date['LSDATE'];
						echo "<div class='grid_16 center'><a href=\"javascript: submitform('form".$l."')\">".$lsdate."</a></div><br />";
						echo "<input type='hidden' name='lsdate' value='".$lsdate."'></form>";
						$l++;
					}
				?>
				<div class='clear'>&nbsp;</div>
