...
$query1 = "Select * from DataBackUp;";
  ...
  {
    $tables = array();
    $result = mysql_query("select `table_name` from information_schema.tables where table_schema = '".$databasename."' and table_name not like '%lookup' and table_type = 'Base Table';",$con);
